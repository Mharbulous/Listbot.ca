# AI Metadata Extraction - UI Mockups

**Related Documentation**:
- `ai-requirements-functional.md` - Requirements FR-6 (AI Tab) and FR-8 (Review Tab)
- `ai-requirements-user-stories.md` - User stories corresponding to these mockups

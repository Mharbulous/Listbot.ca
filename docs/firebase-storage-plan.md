...
- **Firm general** (reserved): `matter-general` - For firm resources, templates, and non-client documents
...
- **`matter-general`** - Firm resources, templates, and non-client documents
...
- **Firm files** → Reserved `matter-general` ID
...
await storageService.uploadFile(
  file,
  firmId,
  'matter-general', // Reserved ID for firm-wide files
  {

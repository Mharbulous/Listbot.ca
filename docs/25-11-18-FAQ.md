...
- `src/features/upload/components/UploadButtons.vue` - File/folder selection with webkitdirectory API
- `src/features/upload/composables/useUploadState.js` - Upload queue state management

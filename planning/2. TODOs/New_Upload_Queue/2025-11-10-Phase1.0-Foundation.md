...
├──────────────┴───────────────────────────────┴──────────┴─────────┴──────────────┴────────────┤
│ Footer:                                                                                       │
│ [UPLOAD]  Total: 720 files (380.3 MB) • TOTAL: 715 • Duplicates: 5 • Failed: 0 • Uploaded: 0│
└───────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌────────────────────────────────────────────────────────────────────────────────┐
│ [🔼 UPLOAD]  Total: 720 files (380.3 MB) • TOTAL: 715 • Duplicates: 5         │
...
- [ ] Implement drag-and-drop zone with recursive folder traversal
- [ ] Add `traverseFileTree()` helper function for folder extraction
- [ ] Style buttons and dropzone with icons and hover states
- [ ] Test file selection workflows
- [ ] Test drag-and-drop with files, folders, and mixed content

...
| `selectedFile` (ref)                               | `selectedUpload`                                    | `src/features/organizer/composables/useFilePreview.js:13`       |
| `selectFile(file)` (function)                      | `selectUpload(upload)`                              | `src/features/organizer/composables/useFilePreview.js:55`       |
| `generatePreview(file)` (function)                 | `generateUploadPreview(upload)`                     | `src/features/organizer/composables/useFilePreview.js:22`       |
...
| `ViewerState.selectedFile` (property)              | `ViewerState.selectedUpload`                        | `src/features/organizer/types/viewer.types.js:35`               |

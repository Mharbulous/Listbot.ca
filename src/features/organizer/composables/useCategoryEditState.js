 ...
 * @param {Ref} params.category - Category ref (shared with validation)
 * @param {Ref} params.editedCategory - Edited category ref (shared with validation)
 * @param {Ref} params.categoryErrors - Category errors ref (shared with validation)

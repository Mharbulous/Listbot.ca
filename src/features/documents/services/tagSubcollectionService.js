...
class TagSubcollectionService {
  ...
  async addTag(docId, tagData, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error adding tag', error, {
        docId,
        categoryId: tagData.categoryId,
      });
      throw error;
  ...
  async addTagsBatch(docId, tagsArray, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error adding tags batch', error, {
        docId,
  ...
  async getTags(docId, options = {}, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error getting tags', error, {
        docId,
      });
      throw error;
    }
  ...
  async getTagsByStatus(docId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error getting tags by status', error, {
        docId,
      });
      throw error;
    }
  ...
  async approveAITag(docId, categoryId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error approving AI tag', error, {
        docId,
        categoryId,
      });
      throw error;
  ...
  async rejectAITag(docId, categoryId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error rejecting AI tag', error, {
        docId,
        categoryId,
      });
      throw error;
  ...
  async approveTagsBatch(docId, categoryIds, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error approving tags batch', error, {
        docId,
  ...
  async rejectTagsBatch(docId, categoryIds, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error rejecting tags batch', error, {
        docId,
        count: categoryIds.length,
      });
      throw error;
  ...
  async deleteTag(docId, tagId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error deleting tag', error, {
        docId,
        tagId,
      });
      throw error;
  ...
  async deleteAllTags(docId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error deleting all tags', error, {
        docId,
      });
      throw error;
    }
  ...
  async getTagStats(docId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error getting tag stats', error, {
        docId,
      });
      throw error;
    }
  ...
  async tagExists(docId, tagId, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error checking tag existence', error, {
        docId,
        tagId,
      });
      return false;
  ...
  async findDuplicateTags(docId, tagName, firmId, matterId = 'general') {
    try {
      ...
      console.error('[TagSubcollectionService] Error finding duplicate tags', error, {
        docId,
        tagName,
      });
      throw error;

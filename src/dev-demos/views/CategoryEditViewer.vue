...
// Shared state refs that both composables will use
...
// Initialize validation composable with shared refs
...
// Initialize state composable with shared refs and validation functions
